...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=azureboardpacdbserver.database.windows.net;Database=AzureBPDB;User ID=sysadmin;Password=p@ssw0rd;MultipleActiveResultSets=true;");
                //Server=(local);Database=AzureBoardPAC;User ID=sa;Password=sysdba123;MultipleActiveResultSets=true;
            }
        }
